...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x02, 0x12, 0x0b, 0x0a, 0x07, 0x53, 0x45, 0x52, 0x56, 0x49, 0x43, 0x45, 0x10, 0x03, 0x2a, 0x2e,
	0x0a, 0x0e, 0x53, 0x74, 0x61, 0x67, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
...
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*AddCmdHistoryRequest)(nil),  // 6: clientpb.AddCmdHistoryRequest
	(*AddCmdHistory)(nil),         // 7: clientpb.AddCmdHistory
	(*HistoryRequest)(nil),        // 8: clientpb.HistoryRequest
	(*History)(nil),               // 9: clientpb.History
	(*GetConsoleConfigReq)(nil),   // 10: clientpb.GetConsoleConfigReq
	(*GetConsoleConfig)(nil),      // 11: clientpb.GetConsoleConfig
	(*SaveConsoleConfigReq)(nil),  // 12: clientpb.SaveConsoleConfigReq
	(*SaveConsoleConfig)(nil),     // 13: clientpb.SaveConsoleConfig
	(*GetSliverSettingsReq)(nil),  // 14: clientpb.GetSliverSettingsReq
	(*GetSliverSettings)(nil),     // 15: clientpb.GetSliverSettings
	(*SaveSliverSettingsReq)(nil), // 16: clientpb.SaveSliverSettingsReq
	(*SaveSliverSettings)(nil),    // 17: clientpb.SaveSliverSettings
	(*Session)(nil),               // 18: clientpb.Session
	(*Beacon)(nil),                // 19: clientpb.Beacon
	(*Beacons)(nil),               // 20: clientpb.Beacons
	(*BeaconTask)(nil),            // 21: clientpb.BeaconTask
	(*BeaconTasks)(nil),           // 22: clientpb.BeaconTasks
	(*ImplantC2)(nil),             // 23: clientpb.ImplantC2
	(*ImplantConfig)(nil),         // 24: clientpb.ImplantConfig
	...
	(*CreateC2ProfileReq)(nil),    // 40: clientpb.CreateC2ProfileReq
	(*CreateC2Profile)(nil),       // 41: clientpb.CreateC2Profile
	(*DeleteC2ProfileReq)(nil),    // 42: clientpb.DeleteC2ProfileReq
	(*DeleteC2Profile)(nil),       // 43: clientpb.DeleteC2Profile
	(*UpdateC2ProfileReq)(nil),    // 44: clientpb.UpdateC2ProfileReq
	(*UpdateC2Profile)(nil),       // 45: clientpb.UpdateC2Profile
	(*GetC2ProfilesReq)(nil),      // 46: clientpb.GetC2ProfilesReq
	(*GetC2Profiles)(nil),         // 47: clientpb.GetC2Profiles
	(*HandlerStageReq)(nil),       // 48: clientpb.HandlerStageReq
	(*HandlerStage)(nil),          // 49: clientpb.HandlerStage
	(*HandlerStagerReq)(nil),      // 50: clientpb.HandlerStagerReq
	(*HandlerStager)(nil),         // 51: clientpb.HandlerStager
	(*HandlerCloseReq)(nil),       // 52: clientpb.HandlerCloseReq
	(*HandlerClose)(nil),          // 53: clientpb.HandlerClose
	(*Transport)(nil),             // 54: clientpb.Transport
	(*AddTransportReq)(nil),       // 55: clientpb.AddTransportReq
	(*AddTransport)(nil),          // 56: clientpb.AddTransport
	(*SwitchTransportReq)(nil),    // 57: clientpb.SwitchTransportReq
	(*SwitchTransport)(nil),       // 58: clientpb.SwitchTransport
	(*DeleteTransportReq)(nil),    // 59: clientpb.DeleteTransportReq
	(*DeleteTransport)(nil),       // 60: clientpb.DeleteTransport
	(*GetTransportsReq)(nil),      // 61: clientpb.GetTransportsReq
	(*GetTransports)(nil),         // 62: clientpb.GetTransports
	(*HTTPListenerReq)(nil),       // 63: clientpb.HTTPListenerReq
	(*NamedPipesReq)(nil),         // 64: clientpb.NamedPipesReq
	(*NamedPipes)(nil),            // 65: clientpb.NamedPipes
	(*TCPPivotReq)(nil),           // 66: clientpb.TCPPivotReq
	(*TCPPivot)(nil),              // 67: clientpb.TCPPivot
	(*HTTPListener)(nil),          // 68: clientpb.HTTPListener
	(*Sessions)(nil),              // 69: clientpb.Sessions
	(*UpdateSession)(nil),         // 70: clientpb.UpdateSession
	(*GenerateReq)(nil),           // 71: clientpb.GenerateReq
	(*Generate)(nil),              // 72: clientpb.Generate
	(*MSFReq)(nil),                // 73: clientpb.MSFReq
	(*MSFRemoteReq)(nil),          // 74: clientpb.MSFRemoteReq
	(*ShellcodeRDIReq)(nil),       // 75: clientpb.ShellcodeRDIReq
	(*ShellcodeRDI)(nil),          // 76: clientpb.ShellcodeRDI
	(*MsfStagerReq)(nil),          // 77: clientpb.MsfStagerReq
	(*MsfStager)(nil),             // 78: clientpb.MsfStager
	(*GetSystemReq)(nil),          // 79: clientpb.GetSystemReq
	(*MigrateReq)(nil),            // 80: clientpb.MigrateReq
	(*CreateTunnelReq)(nil),       // 81: clientpb.CreateTunnelReq
	(*CreateTunnel)(nil),          // 82: clientpb.CreateTunnel
	(*CloseTunnelReq)(nil),        // 83: clientpb.CloseTunnelReq
	...
	(*Credential)(nil),            // 94: clientpb.Credential
	(*Loot)(nil),                  // 95: clientpb.Loot
	(*AllLoot)(nil),               // 96: clientpb.AllLoot
	(*IOC)(nil),                   // 97: clientpb.IOC
	(*ExtensionData)(nil),         // 98: clientpb.ExtensionData
	(*Host)(nil),                  // 99: clientpb.Host
	(*AllHosts)(nil),              // 100: clientpb.AllHosts
	(*DllHijackReq)(nil),          // 101: clientpb.DllHijackReq
	(*DllHijack)(nil),             // 102: clientpb.DllHijack
	nil,                           // 103: clientpb.ImplantBuilds.ConfigsEntry
	nil,                           // 104: clientpb.WebsiteAddContent.ContentsEntry
	nil,                           // 105: clientpb.Website.ContentsEntry
	nil,                           // 106: clientpb.Host.ExtensionDataEntry
	(*commonpb.Request)(nil),      // 107: commonpb.Request
	(*commonpb.Response)(nil),     // 108: commonpb.Response
	(*sliverpb.C2Profile)(nil),    // 109: sliverpb.C2Profile
	(sliverpb.C2Channel)(0),       // 110: sliverpb.C2Channel
	(*commonpb.File)(nil),         // 111: commonpb.File
}
var file_clientpb_client_proto_depIdxs = []int32{
	18,  // 0: clientpb.AddCmdHistoryRequest.Session:type_name -> clientpb.Session
	19,  // 1: clientpb.AddCmdHistoryRequest.Beacon:type_name -> clientpb.Beacon
	107, // 2: clientpb.AddCmdHistoryRequest.Request:type_name -> commonpb.Request
	108, // 3: clientpb.AddCmdHistory.Response:type_name -> commonpb.Response
	18,  // 4: clientpb.HistoryRequest.Session:type_name -> clientpb.Session
	19,  // 5: clientpb.HistoryRequest.Beacon:type_name -> clientpb.Beacon
	107, // 6: clientpb.HistoryRequest.Request:type_name -> commonpb.Request
	108, // 7: clientpb.History.Response:type_name -> commonpb.Response
	107, // 8: clientpb.GetConsoleConfigReq.Request:type_name -> commonpb.Request
	108, // 9: clientpb.GetConsoleConfig.Response:type_name -> commonpb.Response
	107, // 10: clientpb.SaveConsoleConfigReq.Request:type_name -> commonpb.Request
	108, // 11: clientpb.SaveConsoleConfig.Response:type_name -> commonpb.Response
	107, // 12: clientpb.GetSliverSettingsReq.Request:type_name -> commonpb.Request
	108, // 13: clientpb.GetSliverSettings.Response:type_name -> commonpb.Response
	107, // 14: clientpb.SaveSliverSettingsReq.Request:type_name -> commonpb.Request
	108, // 15: clientpb.SaveSliverSettings.Response:type_name -> commonpb.Response
	19,  // 16: clientpb.Beacons.Beacons:type_name -> clientpb.Beacon
	21,  // 17: clientpb.BeaconTasks.Tasks:type_name -> clientpb.BeaconTask
	23,  // 18: clientpb.ImplantConfig.C2:type_name -> clientpb.ImplantC2
	0,   // 19: clientpb.ImplantConfig.Format:type_name -> clientpb.OutputFormat
	109, // 20: clientpb.ImplantConfig.C2s:type_name -> sliverpb.C2Profile
	110, // 21: clientpb.ImplantConfig.RuntimeC2s:type_name -> sliverpb.C2Channel
	103, // 22: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	0,   // 23: clientpb.CompilerTarget.Format:type_name -> clientpb.OutputFormat
	26,  // 24: clientpb.Compiler.Targets:type_name -> clientpb.CompilerTarget
	27,  // 25: clientpb.Compiler.CrossCompilers:type_name -> clientpb.CrossCompiler
	26,  // 26: clientpb.Compiler.UnsupportedTargets:type_name -> clientpb.CompilerTarget
	30,  // 27: clientpb.Canaries.Canaries:type_name -> clientpb.DNSCanary
	24,  // 28: clientpb.ImplantProfile.Config:type_name -> clientpb.ImplantConfig
	33,  // 29: clientpb.ImplantProfiles.Profiles:type_name -> clientpb.ImplantProfile
	109, // 30: clientpb.Job.Profile:type_name -> sliverpb.C2Profile
	36,  // 31: clientpb.Jobs.Active:type_name -> clientpb.Job
	109, // 32: clientpb.CreateC2ProfileReq.Profile:type_name -> sliverpb.C2Profile
	107, // 33: clientpb.CreateC2ProfileReq.Request:type_name -> commonpb.Request
	109, // 34: clientpb.CreateC2Profile.Profile:type_name -> sliverpb.C2Profile
	108, // 35: clientpb.CreateC2Profile.Response:type_name -> commonpb.Response
	109, // 36: clientpb.DeleteC2ProfileReq.Profile:type_name -> sliverpb.C2Profile
	107, // 37: clientpb.DeleteC2ProfileReq.Request:type_name -> commonpb.Request
	108, // 38: clientpb.DeleteC2Profile.Response:type_name -> commonpb.Response
	109, // 39: clientpb.UpdateC2ProfileReq.Profile:type_name -> sliverpb.C2Profile
	107, // 40: clientpb.UpdateC2ProfileReq.Request:type_name -> commonpb.Request
	109, // 41: clientpb.UpdateC2Profile.Updated:type_name -> sliverpb.C2Profile
	108, // 42: clientpb.UpdateC2Profile.Response:type_name -> commonpb.Response
	107, // 43: clientpb.GetC2ProfilesReq.Request:type_name -> commonpb.Request
	109, // 44: clientpb.GetC2Profiles.Profiles:type_name -> sliverpb.C2Profile
	109, // 45: clientpb.HandlerStageReq.Profile:type_name -> sliverpb.C2Profile
	107, // 46: clientpb.HandlerStageReq.Request:type_name -> commonpb.Request
	108, // 47: clientpb.HandlerStage.Response:type_name -> commonpb.Response
	1,   // 48: clientpb.HandlerStagerReq.Protocol:type_name -> clientpb.StagerProtocol
	109, // 49: clientpb.HandlerStagerReq.Profile:type_name -> sliverpb.C2Profile
	107, // 50: clientpb.HandlerStagerReq.Request:type_name -> commonpb.Request
	108, // 51: clientpb.HandlerStager.Response:type_name -> commonpb.Response
	109, // 52: clientpb.HandlerCloseReq.Profile:type_name -> sliverpb.C2Profile
	107, // 53: clientpb.HandlerCloseReq.Request:type_name -> commonpb.Request
	108, // 54: clientpb.HandlerClose.Response:type_name -> commonpb.Response
	109, // 55: clientpb.Transport.Profile:type_name -> sliverpb.C2Profile
	107, // 56: clientpb.AddTransportReq.Request:type_name -> commonpb.Request
	108, // 57: clientpb.AddTransport.Response:type_name -> commonpb.Response
	107, // 58: clientpb.SwitchTransportReq.Request:type_name -> commonpb.Request
	108, // 59: clientpb.SwitchTransport.Response:type_name -> commonpb.Response
	107, // 60: clientpb.DeleteTransportReq.Request:type_name -> commonpb.Request
	108, // 61: clientpb.DeleteTransport.Response:type_name -> commonpb.Response
	107, // 62: clientpb.GetTransportsReq.Request:type_name -> commonpb.Request
	54,  // 63: clientpb.GetTransports.Transports:type_name -> clientpb.Transport
	108, // 64: clientpb.GetTransports.Response:type_name -> commonpb.Response
	107, // 65: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	108, // 66: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	107, // 67: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	108, // 68: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	18,  // 69: clientpb.Sessions.Sessions:type_name -> clientpb.Session
	24,  // 70: clientpb.GenerateReq.Config:type_name -> clientpb.ImplantConfig
	111, // 71: clientpb.Generate.File:type_name -> commonpb.File
	107, // 72: clientpb.MSFReq.Request:type_name -> commonpb.Request
	107, // 73: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	1,   // 74: clientpb.MsfStagerReq.Protocol:type_name -> clientpb.StagerProtocol
	111, // 75: clientpb.MsfStager.File:type_name -> commonpb.File
	24,  // 76: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	107, // 77: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	24,  // 78: clientpb.MigrateReq.Config:type_name -> clientpb.ImplantConfig
	107, // 79: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	107, // 80: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	107, // 81: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	87,  // 82: clientpb.Client.Operator:type_name -> clientpb.Operator
	18,  // 83: clientpb.Event.Session:type_name -> clientpb.Session
	36,  // 84: clientpb.Event.Job:type_name -> clientpb.Job
	84,  // 85: clientpb.Event.Client:type_name -> clientpb.Client
	87,  // 86: clientpb.Operators.Operators:type_name -> clientpb.Operator
	104, // 87: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	105, // 88: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	91,  // 89: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,   // 90: clientpb.Loot.Type:type_name -> clientpb.LootType
	3,   // 91: clientpb.Loot.CredentialType:type_name -> clientpb.CredentialType
	94,  // 92: clientpb.Loot.Credential:type_name -> clientpb.Credential
	4,   // 93: clientpb.Loot.FileType:type_name -> clientpb.FileType
	111, // 94: clientpb.Loot.File:type_name -> commonpb.File
	95,  // 95: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	97,  // 96: clientpb.Host.IOCs:type_name -> clientpb.IOC
	106, // 97: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	99,  // 98: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	107, // 99: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	108, // 100: clientpb.DllHijack.Response:type_name -> commonpb.Response
	24,  // 101: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	88,  // 102: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	88,  // 103: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	98,  // 104: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
