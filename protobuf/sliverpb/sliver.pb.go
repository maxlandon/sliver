...
func (*SockTabEntry_SockAddr) Descriptor() ([]byte, []int) {
	return file_sliverpb_sliver_proto_rawDescGZIP(), []int{66, 0}
}
...
var file_sliverpb_sliver_proto_rawDesc = []byte{
	...
	0x4a, 0x0a, 0x09, 0x43, 0x32, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x08, 0x0a, 0x04,
	0x4d, 0x54, 0x4c, 0x53, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x10, 0x01,
	0x12, 0x09, 0x0a, 0x05, 0x48, 0x54, 0x54, 0x50, 0x53, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x44,
	0x4e, 0x53, 0x10, 0x03, 0x12, 0x06, 0x0a, 0x02, 0x57, 0x47, 0x10, 0x04, 0x12, 0x0d, 0x0a, 0x09,
	0x4e, 0x61, 0x6d, 0x65, 0x64, 0x50, 0x69, 0x70, 0x65, 0x10, 0x05, 0x2a, 0x24, 0x0a, 0x0b, 0x43,
	0x32, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x08, 0x0a, 0x04, 0x42, 0x69,
	0x6e, 0x64, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x65, 0x76, 0x65, 0x72, 0x73, 0x65, 0x10,
...
var file_sliverpb_sliver_proto_goTypes = []interface{}{
	...
	(*Ping)(nil),                     // 18: sliverpb.Ping
	(*KillSessionReq)(nil),           // 19: sliverpb.KillSessionReq
	(*PsReq)(nil),                    // 20: sliverpb.PsReq
	(*Ps)(nil),                       // 21: sliverpb.Ps
	(*TerminateReq)(nil),             // 22: sliverpb.TerminateReq
	(*Terminate)(nil),                // 23: sliverpb.Terminate
	(*IfconfigReq)(nil),              // 24: sliverpb.IfconfigReq
	(*Ifconfig)(nil),                 // 25: sliverpb.Ifconfig
	(*NetInterface)(nil),             // 26: sliverpb.NetInterface
	(*LsReq)(nil),                    // 27: sliverpb.LsReq
	(*Ls)(nil),                       // 28: sliverpb.Ls
	(*FileInfo)(nil),                 // 29: sliverpb.FileInfo
	(*CdReq)(nil),                    // 30: sliverpb.CdReq
	(*PwdReq)(nil),                   // 31: sliverpb.PwdReq
	(*Pwd)(nil),                      // 32: sliverpb.Pwd
	(*RmReq)(nil),                    // 33: sliverpb.RmReq
	(*Rm)(nil),                       // 34: sliverpb.Rm
	(*MkdirReq)(nil),                 // 35: sliverpb.MkdirReq
	(*Mkdir)(nil),                    // 36: sliverpb.Mkdir
	(*DownloadReq)(nil),              // 37: sliverpb.DownloadReq
	(*Download)(nil),                 // 38: sliverpb.Download
	(*UploadReq)(nil),                // 39: sliverpb.UploadReq
	(*Upload)(nil),                   // 40: sliverpb.Upload
	(*ProcessDumpReq)(nil),           // 41: sliverpb.ProcessDumpReq
	(*ProcessDump)(nil),              // 42: sliverpb.ProcessDump
	(*RunAsReq)(nil),                 // 43: sliverpb.RunAsReq
	(*RunAs)(nil),                    // 44: sliverpb.RunAs
	(*ImpersonateReq)(nil),           // 45: sliverpb.ImpersonateReq
	(*Impersonate)(nil),              // 46: sliverpb.Impersonate
	(*RevToSelfReq)(nil),             // 47: sliverpb.RevToSelfReq
	(*RevToSelf)(nil),                // 48: sliverpb.RevToSelf
	(*InvokeGetSystemReq)(nil),       // 49: sliverpb.InvokeGetSystemReq
	(*GetSystem)(nil),                // 50: sliverpb.GetSystem
	(*MakeTokenReq)(nil),             // 51: sliverpb.MakeTokenReq
	(*MakeToken)(nil),                // 52: sliverpb.MakeToken
	(*TaskReq)(nil),                  // 53: sliverpb.TaskReq
	(*Task)(nil),                     // 54: sliverpb.Task
	(*ExecuteAssemblyReq)(nil),       // 55: sliverpb.ExecuteAssemblyReq
	(*InvokeExecuteAssemblyReq)(nil), // 56: sliverpb.InvokeExecuteAssemblyReq
	(*ExecuteAssembly)(nil),          // 57: sliverpb.ExecuteAssembly
	(*InvokeMigrateReq)(nil),         // 58: sliverpb.InvokeMigrateReq
	(*Migrate)(nil),                  // 59: sliverpb.Migrate
	(*ExecuteReq)(nil),               // 60: sliverpb.ExecuteReq
	(*ExecuteTokenReq)(nil),          // 61: sliverpb.ExecuteTokenReq
	(*Execute)(nil),                  // 62: sliverpb.Execute
	(*SideloadReq)(nil),              // 63: sliverpb.SideloadReq
	(*Sideload)(nil),                 // 64: sliverpb.Sideload
	(*InvokeSpawnDllReq)(nil),        // 65: sliverpb.InvokeSpawnDllReq
	(*SpawnDllReq)(nil),              // 66: sliverpb.SpawnDllReq
	(*SpawnDll)(nil),                 // 67: sliverpb.SpawnDll
	(*NetstatReq)(nil),               // 68: sliverpb.NetstatReq
	(*SockTabEntry)(nil),             // 69: sliverpb.SockTabEntry
	(*Netstat)(nil),                  // 70: sliverpb.Netstat
	(*EnvReq)(nil),                   // 71: sliverpb.EnvReq
	(*EnvInfo)(nil),                  // 72: sliverpb.EnvInfo
	(*SetEnvReq)(nil),                // 73: sliverpb.SetEnvReq
	(*SetEnv)(nil),                   // 74: sliverpb.SetEnv
	(*UnsetEnvReq)(nil),              // 75: sliverpb.UnsetEnvReq
	(*UnsetEnv)(nil),                 // 76: sliverpb.UnsetEnv
	(*DNSSessionInit)(nil),           // 77: sliverpb.DNSSessionInit
	(*DNSPoll)(nil),                  // 78: sliverpb.DNSPoll
	(*DNSBlockHeader)(nil),           // 79: sliverpb.DNSBlockHeader
	(*HTTPSessionInit)(nil),          // 80: sliverpb.HTTPSessionInit
	(*ScreenshotReq)(nil),            // 81: sliverpb.ScreenshotReq
	(*Screenshot)(nil),               // 82: sliverpb.Screenshot
	(*StartServiceReq)(nil),          // 83: sliverpb.StartServiceReq
	(*ServiceInfo)(nil),              // 84: sliverpb.ServiceInfo
	(*ServiceInfoReq)(nil),           // 85: sliverpb.ServiceInfoReq
	(*StopServiceReq)(nil),           // 86: sliverpb.StopServiceReq
	(*RemoveServiceReq)(nil),         // 87: sliverpb.RemoveServiceReq
	(*BackdoorReq)(nil),              // 88: sliverpb.BackdoorReq
	(*Backdoor)(nil),                 // 89: sliverpb.Backdoor
	(*RegistryReadReq)(nil),          // 90: sliverpb.RegistryReadReq
	(*RegistryRead)(nil),             // 91: sliverpb.RegistryRead
	(*RegistryWriteReq)(nil),         // 92: sliverpb.RegistryWriteReq
	(*RegistryWrite)(nil),            // 93: sliverpb.RegistryWrite
	(*RegistryCreateKeyReq)(nil),     // 94: sliverpb.RegistryCreateKeyReq
	(*RegistryCreateKey)(nil),        // 95: sliverpb.RegistryCreateKey
	...
	(*NamedPipesReq)(nil),            // 106: sliverpb.NamedPipesReq
	(*NamedPipes)(nil),               // 107: sliverpb.NamedPipes
	(*TCPPivotReq)(nil),              // 108: sliverpb.TCPPivotReq
	(*TCPPivot)(nil),                 // 109: sliverpb.TCPPivot
	(*PivotOpen)(nil),                // 110: sliverpb.PivotOpen
	(*PivotClose)(nil),               // 111: sliverpb.PivotClose
	(*PivotData)(nil),                // 112: sliverpb.PivotData
	(*PivotEntry)(nil),               // 113: sliverpb.PivotEntry
	(*PivotListReq)(nil),             // 114: sliverpb.PivotListReq
	(*PivotList)(nil),                // 115: sliverpb.PivotList
	(*WGPortForwardStartReq)(nil),    // 116: sliverpb.WGPortForwardStartReq
	(*WGPortForward)(nil),            // 117: sliverpb.WGPortForward
	(*WGPortForwardStopReq)(nil),     // 118: sliverpb.WGPortForwardStopReq
	(*WGSocksStartReq)(nil),          // 119: sliverpb.WGSocksStartReq
	(*WGSocks)(nil),                  // 120: sliverpb.WGSocks
	(*WGSocksStopReq)(nil),           // 121: sliverpb.WGSocksStopReq
	(*WGTCPForwardersReq)(nil),       // 122: sliverpb.WGTCPForwardersReq
	(*WGSocksServersReq)(nil),        // 123: sliverpb.WGSocksServersReq
	(*WGTCPForwarder)(nil),           // 124: sliverpb.WGTCPForwarder
	(*WGSocksServer)(nil),            // 125: sliverpb.WGSocksServer
	(*WGSocksServers)(nil),           // 126: sliverpb.WGSocksServers
	(*WGTCPForwarders)(nil),          // 127: sliverpb.WGTCPForwarders
	(*ReconnectIntervalReq)(nil),     // 128: sliverpb.ReconnectIntervalReq
	(*ReconnectInterval)(nil),        // 129: sliverpb.ReconnectInterval
	(*PollIntervalReq)(nil),          // 130: sliverpb.PollIntervalReq
	(*PollInterval)(nil),             // 131: sliverpb.PollInterval
	(*SSHCommandReq)(nil),            // 132: sliverpb.SSHCommandReq
	(*SSHCommand)(nil),               // 133: sliverpb.SSHCommand
	(*GetPrivsReq)(nil),              // 134: sliverpb.GetPrivsReq
	(*WindowsPrivilegeEntry)(nil),    // 135: sliverpb.WindowsPrivilegeEntry
	(*GetPrivs)(nil),                 // 136: sliverpb.GetPrivs
	(*RegisterExtensionReq)(nil),     // 137: sliverpb.RegisterExtensionReq
	(*RegisterExtension)(nil),        // 138: sliverpb.RegisterExtension
	(*CallExtensionReq)(nil),         // 139: sliverpb.CallExtensionReq
	(*CallExtension)(nil),            // 140: sliverpb.CallExtension
	(*ListExtensionsReq)(nil),        // 141: sliverpb.ListExtensionsReq
	(*ListExtensions)(nil),           // 142: sliverpb.ListExtensions
	(*SockTabEntry_SockAddr)(nil),    // 143: sliverpb.SockTabEntry.SockAddr
	(*commonpb.Request)(nil),         // 144: commonpb.Request
	(*commonpb.Response)(nil),        // 145: commonpb.Response
	(*commonpb.Process)(nil),         // 146: commonpb.Process
	(*commonpb.EnvVar)(nil),          // 147: commonpb.EnvVar
}
var file_sliverpb_sliver_proto_depIdxs = []int32{
	...
	144, // 7: sliverpb.TransportsReq.Request:type_name -> commonpb.Request
	7,   // 8: sliverpb.Transports.Available:type_name -> sliverpb.C2Profile
	145, // 9: sliverpb.Transports.Response:type_name -> commonpb.Response
	7,   // 10: sliverpb.TransportAddReq.Profile:type_name -> sliverpb.C2Profile
	144, // 11: sliverpb.TransportAddReq.Request:type_name -> commonpb.Request
	145, // 12: sliverpb.TransportAdd.Response:type_name -> commonpb.Response
	144, // 13: sliverpb.TransportDeleteReq.Request:type_name -> commonpb.Request
	145, // 14: sliverpb.TransportDelete.Response:type_name -> commonpb.Response
	144, // 15: sliverpb.TransportSwitchReq.Request:type_name -> commonpb.Request
	145, // 16: sliverpb.TransportSwitch.Response:type_name -> commonpb.Response
	145, // 17: sliverpb.Ping.Response:type_name -> commonpb.Response
	144, // 18: sliverpb.Ping.Request:type_name -> commonpb.Request
	144, // 19: sliverpb.KillSessionReq.Request:type_name -> commonpb.Request
	144, // 20: sliverpb.PsReq.Request:type_name -> commonpb.Request
	146, // 21: sliverpb.Ps.Processes:type_name -> commonpb.Process
	145, // 22: sliverpb.Ps.Response:type_name -> commonpb.Response
	144, // 23: sliverpb.TerminateReq.Request:type_name -> commonpb.Request
	145, // 24: sliverpb.Terminate.Response:type_name -> commonpb.Response
	144, // 25: sliverpb.IfconfigReq.Request:type_name -> commonpb.Request
	26,  // 26: sliverpb.Ifconfig.NetInterfaces:type_name -> sliverpb.NetInterface
	145, // 27: sliverpb.Ifconfig.Response:type_name -> commonpb.Response
	144, // 28: sliverpb.LsReq.Request:type_name -> commonpb.Request
	29,  // 29: sliverpb.Ls.Files:type_name -> sliverpb.FileInfo
	145, // 30: sliverpb.Ls.Response:type_name -> commonpb.Response
	144, // 31: sliverpb.CdReq.Request:type_name -> commonpb.Request
	144, // 32: sliverpb.PwdReq.Request:type_name -> commonpb.Request
	145, // 33: sliverpb.Pwd.Response:type_name -> commonpb.Response
	144, // 34: sliverpb.RmReq.Request:type_name -> commonpb.Request
	145, // 35: sliverpb.Rm.Response:type_name -> commonpb.Response
	144, // 36: sliverpb.MkdirReq.Request:type_name -> commonpb.Request
	145, // 37: sliverpb.Mkdir.Response:type_name -> commonpb.Response
	144, // 38: sliverpb.DownloadReq.Request:type_name -> commonpb.Request
	145, // 39: sliverpb.Download.Response:type_name -> commonpb.Response
	144, // 40: sliverpb.UploadReq.Request:type_name -> commonpb.Request
	145, // 41: sliverpb.Upload.Response:type_name -> commonpb.Response
	144, // 42: sliverpb.ProcessDumpReq.Request:type_name -> commonpb.Request
	145, // 43: sliverpb.ProcessDump.Response:type_name -> commonpb.Response
	144, // 44: sliverpb.RunAsReq.Request:type_name -> commonpb.Request
	145, // 45: sliverpb.RunAs.Response:type_name -> commonpb.Response
	144, // 46: sliverpb.ImpersonateReq.Request:type_name -> commonpb.Request
	145, // 47: sliverpb.Impersonate.Response:type_name -> commonpb.Response
	144, // 48: sliverpb.RevToSelfReq.Request:type_name -> commonpb.Request
	145, // 49: sliverpb.RevToSelf.Response:type_name -> commonpb.Response
	144, // 50: sliverpb.InvokeGetSystemReq.Request:type_name -> commonpb.Request
	145, // 51: sliverpb.GetSystem.Response:type_name -> commonpb.Response
	144, // 52: sliverpb.MakeTokenReq.Request:type_name -> commonpb.Request
	145, // 53: sliverpb.MakeToken.Response:type_name -> commonpb.Response
	144, // 54: sliverpb.TaskReq.Request:type_name -> commonpb.Request
	145, // 55: sliverpb.Task.Response:type_name -> commonpb.Response
	144, // 56: sliverpb.ExecuteAssemblyReq.Request:type_name -> commonpb.Request
	144, // 57: sliverpb.InvokeExecuteAssemblyReq.Request:type_name -> commonpb.Request
	145, // 58: sliverpb.ExecuteAssembly.Response:type_name -> commonpb.Response
	144, // 59: sliverpb.InvokeMigrateReq.Request:type_name -> commonpb.Request
	145, // 60: sliverpb.Migrate.Response:type_name -> commonpb.Response
	144, // 61: sliverpb.ExecuteReq.Request:type_name -> commonpb.Request
	144, // 62: sliverpb.ExecuteTokenReq.Request:type_name -> commonpb.Request
	145, // 63: sliverpb.Execute.Response:type_name -> commonpb.Response
	144, // 64: sliverpb.SideloadReq.Request:type_name -> commonpb.Request
	145, // 65: sliverpb.Sideload.Response:type_name -> commonpb.Response
	144, // 66: sliverpb.InvokeSpawnDllReq.Request:type_name -> commonpb.Request
	144, // 67: sliverpb.SpawnDllReq.Request:type_name -> commonpb.Request
	145, // 68: sliverpb.SpawnDll.Response:type_name -> commonpb.Response
	144, // 69: sliverpb.NetstatReq.Request:type_name -> commonpb.Request
	143, // 70: sliverpb.SockTabEntry.LocalAddr:type_name -> sliverpb.SockTabEntry.SockAddr
	143, // 71: sliverpb.SockTabEntry.RemoteAddr:type_name -> sliverpb.SockTabEntry.SockAddr
	146, // 72: sliverpb.SockTabEntry.Process:type_name -> commonpb.Process
	69,  // 73: sliverpb.Netstat.Entries:type_name -> sliverpb.SockTabEntry
	145, // 74: sliverpb.Netstat.Response:type_name -> commonpb.Response
	144, // 75: sliverpb.EnvReq.Request:type_name -> commonpb.Request
	147, // 76: sliverpb.EnvInfo.Variables:type_name -> commonpb.EnvVar
	145, // 77: sliverpb.EnvInfo.Response:type_name -> commonpb.Response
	147, // 78: sliverpb.SetEnvReq.Variable:type_name -> commonpb.EnvVar
	144, // 79: sliverpb.SetEnvReq.Request:type_name -> commonpb.Request
	145, // 80: sliverpb.SetEnv.Response:type_name -> commonpb.Response
	144, // 81: sliverpb.UnsetEnvReq.Request:type_name -> commonpb.Request
	145, // 82: sliverpb.UnsetEnv.Response:type_name -> commonpb.Response
	79,  // 83: sliverpb.DNSPoll.blocks:type_name -> sliverpb.DNSBlockHeader
	144, // 84: sliverpb.ScreenshotReq.Request:type_name -> commonpb.Request
	145, // 85: sliverpb.Screenshot.Response:type_name -> commonpb.Response
	144, // 86: sliverpb.StartServiceReq.Request:type_name -> commonpb.Request
	145, // 87: sliverpb.ServiceInfo.Response:type_name -> commonpb.Response
	85,  // 88: sliverpb.StopServiceReq.ServiceInfo:type_name -> sliverpb.ServiceInfoReq
	144, // 89: sliverpb.StopServiceReq.Request:type_name -> commonpb.Request
	85,  // 90: sliverpb.RemoveServiceReq.ServiceInfo:type_name -> sliverpb.ServiceInfoReq
	144, // 91: sliverpb.RemoveServiceReq.Request:type_name -> commonpb.Request
	144, // 92: sliverpb.BackdoorReq.Request:type_name -> commonpb.Request
	145, // 93: sliverpb.Backdoor.Response:type_name -> commonpb.Response
	144, // 94: sliverpb.RegistryReadReq.Request:type_name -> commonpb.Request
	145, // 95: sliverpb.RegistryRead.Response:type_name -> commonpb.Response
	144, // 96: sliverpb.RegistryWriteReq.Request:type_name -> commonpb.Request
	145, // 97: sliverpb.RegistryWrite.Response:type_name -> commonpb.Response
	144, // 98: sliverpb.RegistryCreateKeyReq.Request:type_name -> commonpb.Request
	145, // 99: sliverpb.RegistryCreateKey.Response:type_name -> commonpb.Response
	144, // 100: sliverpb.RegistrySubKeyListReq.Request:type_name -> commonpb.Request
	145, // 101: sliverpb.RegistrySubKeyList.Response:type_name -> commonpb.Response
	144, // 102: sliverpb.RegistryListValuesReq.Request:type_name -> commonpb.Request
	145, // 103: sliverpb.RegistryValuesList.Response:type_name -> commonpb.Response
	144, // 104: sliverpb.ShellReq.Request:type_name -> commonpb.Request
	145, // 105: sliverpb.Shell.Response:type_name -> commonpb.Response
	144, // 106: sliverpb.PortfwdReq.Request:type_name -> commonpb.Request
	145, // 107: sliverpb.Portfwd.Response:type_name -> commonpb.Response
	144, // 108: sliverpb.NamedPipesReq.Request:type_name -> commonpb.Request
	145, // 109: sliverpb.NamedPipes.Response:type_name -> commonpb.Response
	144, // 110: sliverpb.TCPPivotReq.Request:type_name -> commonpb.Request
	145, // 111: sliverpb.TCPPivot.Response:type_name -> commonpb.Response
	144, // 112: sliverpb.PivotListReq.Request:type_name -> commonpb.Request
	113, // 113: sliverpb.PivotList.Entries:type_name -> sliverpb.PivotEntry
	145, // 114: sliverpb.PivotList.Response:type_name -> commonpb.Response
	144, // 115: sliverpb.WGPortForwardStartReq.Request:type_name -> commonpb.Request
	124, // 116: sliverpb.WGPortForward.Forwarder:type_name -> sliverpb.WGTCPForwarder
	145, // 117: sliverpb.WGPortForward.Response:type_name -> commonpb.Response
	144, // 118: sliverpb.WGPortForwardStopReq.Request:type_name -> commonpb.Request
	144, // 119: sliverpb.WGSocksStartReq.Request:type_name -> commonpb.Request
	125, // 120: sliverpb.WGSocks.Server:type_name -> sliverpb.WGSocksServer
	145, // 121: sliverpb.WGSocks.Response:type_name -> commonpb.Response
	144, // 122: sliverpb.WGSocksStopReq.Request:type_name -> commonpb.Request
	144, // 123: sliverpb.WGTCPForwardersReq.Request:type_name -> commonpb.Request
	144, // 124: sliverpb.WGSocksServersReq.Request:type_name -> commonpb.Request
	125, // 125: sliverpb.WGSocksServers.Servers:type_name -> sliverpb.WGSocksServer
	145, // 126: sliverpb.WGSocksServers.Response:type_name -> commonpb.Response
	124, // 127: sliverpb.WGTCPForwarders.Forwarders:type_name -> sliverpb.WGTCPForwarder
	145, // 128: sliverpb.WGTCPForwarders.Response:type_name -> commonpb.Response
	144, // 129: sliverpb.ReconnectIntervalReq.Request:type_name -> commonpb.Request
	145, // 130: sliverpb.ReconnectInterval.Response:type_name -> commonpb.Response
	144, // 131: sliverpb.PollIntervalReq.Request:type_name -> commonpb.Request
	145, // 132: sliverpb.PollInterval.Response:type_name -> commonpb.Response
	144, // 133: sliverpb.SSHCommandReq.Request:type_name -> commonpb.Request
	145, // 134: sliverpb.SSHCommand.Response:type_name -> commonpb.Response
	144, // 135: sliverpb.GetPrivsReq.Request:type_name -> commonpb.Request
	135, // 136: sliverpb.GetPrivs.PrivInfo:type_name -> sliverpb.WindowsPrivilegeEntry
	145, // 137: sliverpb.GetPrivs.Response:type_name -> commonpb.Response
	144, // 138: sliverpb.RegisterExtensionReq.Request:type_name -> commonpb.Request
	145, // 139: sliverpb.RegisterExtension.Response:type_name -> commonpb.Response
	144, // 140: sliverpb.CallExtensionReq.Request:type_name -> commonpb.Request
	145, // 141: sliverpb.CallExtension.Response:type_name -> commonpb.Response
	144, // 142: sliverpb.ListExtensionsReq.Request:type_name -> commonpb.Request
	145, // 143: sliverpb.ListExtensions.Response:type_name -> commonpb.Response
