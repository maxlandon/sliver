...
type SliverRPCClient interface {
	...
	GetImplantConfig(ctx context.Context, in *commonpb.Request, opts ...grpc.CallOption) (*clientpb.ImplantConfig, error)
	// *** Websites ***
...
func (c *sliverRPCClient) LoadSliverSettings(ctx context.Context, in *clientpb.GetSliverSettingsReq, opts ...grpc.CallOption) (*clientpb.GetSliverSettings, error) {
	out := new(clientpb.GetSliverSettings)
	err := c.cc.Invoke(ctx, "/rpcpb.SliverRPC/LoadSliverSettings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sliverRPCClient) GetImplantConfig(ctx context.Context, in *commonpb.Request, opts ...grpc.CallOption) (*clientpb.ImplantConfig, error) {
	out := new(clientpb.ImplantConfig)
	err := c.cc.Invoke(ctx, "/rpcpb.SliverRPC/GetImplantConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SliverRPCServer interface {
	...
	GetImplantConfig(context.Context, *commonpb.Request) (*clientpb.ImplantConfig, error)
	// *** Websites ***
...
func (UnimplementedSliverRPCServer) LoadSliverSettings(context.Context, *clientpb.GetSliverSettingsReq) (*clientpb.GetSliverSettings, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoadSliverSettings not implemented")
}
...
func (UnimplementedSliverRPCServer) GetImplantConfig(context.Context, *commonpb.Request) (*clientpb.ImplantConfig, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetImplantConfig not implemented")
}
...
func _SliverRPC_LoadSliverSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(clientpb.GetSliverSettingsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).LoadSliverSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcpb.SliverRPC/LoadSliverSettings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).LoadSliverSettings(ctx, req.(*clientpb.GetSliverSettingsReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _SliverRPC_SaveUserSliverSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(clientpb.SaveSliverSettingsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).SaveUserSliverSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcpb.SliverRPC/SaveUserSliverSettings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SliverRPC_GetImplantConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(commonpb.Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).GetImplantConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcpb.SliverRPC/GetImplantConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).GetImplantConfig(ctx, req.(*commonpb.Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SliverRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LoadSliverSettings",
			Handler:    _SliverRPC_LoadSliverSettings_Handler,
		},
		{
		...
		{
			MethodName: "GetImplantConfig",
			Handler:    _SliverRPC_GetImplantConfig_Handler,
		},
		{
			MethodName: "Websites",
