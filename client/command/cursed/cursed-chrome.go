...
func CursedChromeCmd(cmd *cobra.Command, con *console.SliverConsole, args []string) {
...
func avadaKedavraChrome(session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole, cargs []string) *core.CursedProcess {
...
func startCursedChromeProcess(isEdge bool, session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole, cargs []string) (*core.CursedProcess, error) {
	name := "Chrome"
	if isEdge {
		name = "Edge"
	}
...
func findChromeUserDataDir(isEdge bool, session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole) (string, error) {
...
func findChromeExecutablePath(isEdge bool, session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole) (string, error) {
...
func getChromeProcess(session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole) (*commonpb.Process, error) {
