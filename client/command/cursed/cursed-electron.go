...
func CursedElectronCmd(cmd *cobra.Command, con *console.SliverConsole, args []string) {
...
func avadaKedavraElectron(electronExe string, session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole, cargs []string) *core.CursedProcess {
...
func checkElectronPath(electronExe string, session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole) (bool, error) {
...
func checkElectronProcess(electronExe string, session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole) (*commonpb.Process, error) {
...
func startCursedElectronProcess(electronExe string, session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole, cargs []string) (*core.CursedProcess, error) {
...
func getElectronProcess(session *clientpb.Session, cmd *cobra.Command, con *console.SliverConsole) (*commonpb.Process, error) {
	ps, err := con.Rpc.Ps(context.Background(), &sliverpb.PsReq{
		Request: con.ActiveTarget.Request(cmd),
	})
	if err != nil {
