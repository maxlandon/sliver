...
func Commands(con *console.SliverClient) []*cobra.Command {
	...
	completers.NewFlagCompsFor(exportC2ProfileCmd, func(comp *carapace.ActionMap) {
		(*comp)["name"] = generate.HTTPC2Completer(con)
	})
	...
	completers.NewFlagCompsFor(generateC2ProfileCmd, func(comp *carapace.ActionMap) {
