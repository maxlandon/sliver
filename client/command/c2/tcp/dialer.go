...
// TCP - TCP handlers/profiles root management command
type TCP struct{}

// Execute - TCP handlers/profiles root management command
func (m *TCP) Execute(args []string) (err error) {
	return
}

// Dialer - Create a new TCP dialer C2 Profile
type Dialer struct {
	Args struct {
...
// Execute - Create a new TCP dialer C2 Profile
