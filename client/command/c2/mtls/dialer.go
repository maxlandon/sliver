...
// MTLS - MutualTLS handlers/profiles root management command
type MTLS struct{}

// Execute - MutualTLS handlers/profiles root management command
func (m *MTLS) Execute(args []string) (err error) {
	return
}

// Dialer - Create a new MutualTLS dialer C2 Profile
type Dialer struct {
	Args struct {
...
// Execute - Create a new MutualTLS dialer C2 Profile
