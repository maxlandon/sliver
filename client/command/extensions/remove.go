...
func ExtensionsRemoveCmd(cmd *cobra.Command, con *console.SliverConsole, args []string) {
	name := args[0]
	if name == "" {
...
func RemoveExtensionByCommandName(commandName string, con *console.SliverConsole) error {
	if commandName == "" {
