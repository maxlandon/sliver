...
func ExtensionLoadCmd(cmd *cobra.Command, con *console.SliverConsole, args []string) {
	dirPath := args[0]
...
func ExtensionRegisterCommand(extCmd *ExtensionManifest, cmd *cobra.Command, con *console.SliverConsole) {
...
func registerExtension(goos string, ext *ExtensionManifest, binData []byte, cmd *cobra.Command, con *console.SliverConsole) error {
...
func loadDep(goos string, goarch string, depName string, cmd *cobra.Command, con *console.SliverConsole) error {
...
func runExtensionCmd(cmd *cobra.Command, con *console.SliverConsole, args []string) {
	var (
		err           error
		extensionArgs []byte
		extName       string
