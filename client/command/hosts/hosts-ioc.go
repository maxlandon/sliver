...
func hostIOCsTable(host *clientpb.Host, con *console.SliverConsole) string {
	tw := table.NewWriter()
...
func SelectHostIOC(host *clientpb.Host, con *console.SliverConsole) (*clientpb.IOC, error) {
